                     ...
                     andMainView:(UIViewController *)mainVC
{
    if(self = [super init]){
        ...
        self.leftVC.view.frame = CGRectMake(0, 0, kScreenWidth, kScreenHeight);
        [self.view addSubview:self.leftVC.view];
        
        self.mainVC.view.frame = CGRectMake(0, 0, kScreenWidth, kScreenHeight);
        self.mainVC.view.center = kRightDefaultCenter;
...
- (void) handlePan: (UIPanGestureRecognizer *)rec{
    ...
    if (((self.mainVC.view.x < kRightDefaultDistance - 2) && (_scalef <= 0)) || ((self.mainVC.view.x >= (kScreenWidth - kMainPageDistance )) && (_scalef >= 0)))
    {
        //边界值管控
        _scalef = 0;
        needMoveWithTap = NO;
